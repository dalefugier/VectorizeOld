...
//
// 2020-2021 Dale Fugier
// Added support for Rhino and Eto bitmaps
// Some other clean up too
...
namespace Vectorize
{
  ...
  public class dPoint
  {
    ...
    public Rhino.Geometry.Point3d ToPoint3d()
    {
      return new Rhino.Geometry.Point3d(x, y, 0.0);
    }
  }
